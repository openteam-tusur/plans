class Message < ActiveRecord::Base
  ...
  scope :checks_by_provided_subdepartment,  ->(user){ unreaded.where(:work_programm_id => WorkProgramm.checks_by_provided_subdepartment(user)) }
  scope :checks_by_profiled_subdepartment,  ->(user){ unreaded.where(:work_programm_id => WorkProgramm.checks_by_profiled_subdepartment(user)) }
  scope :checks_by_graduated_subdepartment, ->(user){ unreaded.where(:work_programm_id => WorkProgramm.checks_by_graduated_subdepartment(user)) }
