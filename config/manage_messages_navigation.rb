SimpleNavigation::Configuration.run do |navigation|
  navigation.items do |primary|
    %w(drafts reduxes checks_by_provided_subdepartment checks_by_profiled_subdepartment checks_by_graduated_subdepartment checks_by_library checks_by_methodological_office checks_by_educational_office releases).each do |folder|
